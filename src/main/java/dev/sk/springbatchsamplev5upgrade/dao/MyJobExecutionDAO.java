...
* ===============================
* lastExec.getCreateTime().before(exec.getCreateTime()) => lastExec.getCreateTime().isBefore(exec.getCreateTime())
* */

public class MyJobExecutionDAO implements JobExecutionDao {
    ...
    public JobExecution getLastJobExecution(@Nullable JobInstance jobInstance) {
        ...
        for (JobExecution exec : executionsById.values()) {
            ...
            if (lastExec.getCreateTime().isBefore(exec.getCreateTime())) {
                lastExec = exec;
            }
        }
